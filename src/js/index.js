...
function render(variables = {}) {
  ...
  if (variables.role == null) variables.role = "null";
  if (variables.city == null) variables.city = "null";
  if (variables.country == null) variables.country = "null";
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${variables.socialMediaPosition}">
            ...
            <li><a href="https://www.instagram.com/${variables.instagram}/" target="_blank"><i class="fa fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
